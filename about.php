            ...
            <div class="row d-flex align-items-center justify-content-center">
                <div class="about-content col-lg-12">
                    ...
                    <p class="text-white link-nav"><a href="index.php">Home</a> <span
                            class="lnr lnr-arrow-right"></span> <a href="about.html"> Universidade Harvard </a></p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-lg-6 no-padding info-area-left">
                    <img class="img-fluid" src="img/nois.jpg" alt="" style="
    padding-top: 10%;
">
                </div>
                <div class="col-lg-6 info-area-right">
                    <h1>Quem somos </h1>
                    <p>  Fundada em 1636 na cidade de Cambridge, Harvard é a mais antiga e conhecida universidade dos Estados Unidos. Inicialmente chamada de New College, ganhou seu nome icônico três anos após a fundação, em uma homenagem a John Harvard, um de seus primeiros benfeitores.</p>
                    <br>
                    <p>
