        ...
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-lg-6 no-padding info-area-left">
                    <img class="img-fluid" src="img/cacadores.jpeg" alt="10px" style="padding-top: 10%;">
                </div>
                <div class="col-lg-6 info-area-right">
                    <h1>Quem somos </h1>
                    <p>Nós somos os mais temidos caçadores de recompenças da América Látina!</p>                
                    <br>

                    <p>
                    ja fomos contratados para servir o exército brasileiro em missões de paz pela ONU,
                    mas nem tudo são flores, por missões envolvendo muitos civis abamos se afastando de missões desse gênero, 
                    hoje em dia trabalhamos de forma autônoma, atrás de malfeitores!
                    </p>
                    <br>
                    <p>Aceitamos PIX e parcelamos em até 10x no cartão de crédito!</p>
                </div>
            </div>
        </div>
    </section>
