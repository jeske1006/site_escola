...
<table class="table table-sm table-dark">
    ...
    <tbody>
        ...
        <?php foreach ($listaDeCurso as $c) { ?>
            <tr>
                <td><?php echo $c['codcur']; ?></td>

                <td>
                    <a href="editarCurso.php?codcur=<?php echo $c['codcur']; ?>">
                        <?php echo utf8_encode($c['nomcur']); ?>
                    </a>
                </td>
                <td><?php echo $c['desccur']; ?></td>

                    <td>
                        <a href="eliminarCurso.php?codcur=<?php echo $c ['codcur'];?>">
                        Eliminar
                        </a>
                    </td>
